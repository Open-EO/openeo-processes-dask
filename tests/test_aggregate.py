...
from openeo_processes_dask.process_implementations.cubes.aggregate import aggregate_temporal_period
from openeo_processes_dask.process_implementations.math import mean
from openeo_pg_parser_networkx.pg_schema import BoundingBox, TemporalInterval


@pytest.mark.parametrize("incoming_temporal_extent,period,expected",[
...
def test_aggregate_temporal_period(incoming_temporal_extent, period, expected, mock_rastercube_factory):
    """"""
    ...
    test_data = load_fake_datacube("test", spatial_extent=BoundingBox.parse_obj(spatial_extent), temporal_extent=TemporalInterval.parse_obj(temporal_extent), bands=bands)
